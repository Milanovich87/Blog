...
// @ts-ignore-start
import SpacePost from '../../assets/images/SpacePost.png'
// @ts-ignore-end
        ...
        <div className={`post--${theme}`}>
            <div className="post__header">
                <div className="post__button">
                    <Button className='button__home' onClick={onClickHome}>{'Home'}</Button>
                </div>
                <div className="post__number">
                    <p className='number'>Post 14278</p>
                </div>
            </div>
            ...
            <div className='post__footer'>
                <div className='post__like'>
                    <Button className='button-like' onClick={onClick} icon={<SvgLike />}><span>{countstr}</span></Button>
                    <Button className='button-dis-like' onClick={onClick2} icon={<SvgDisLike />}><span>{countstr2}</span></Button>
                </div>
                <div className='post__edit'>
                    <Button className='button-book-mark' text='Add to favorites' icon={<SvgBookMark />} />
                </div>
            </div>
